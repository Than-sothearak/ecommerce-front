    ...
    <>
      <ProductWrapper>
        ...
        <PriceRow>
          ...
          <Price>
            <h1> ${USDollar.format(parseInt(product.price))}</h1>
            <h5>${USDollar.format(parseInt(product.price) + 100)}</h5>
          </Price>
          <FooterButton>
            <ShipingText>
            <h4>Free Shipping</h4>
            ...
            <Button onClick={() => addProduct(product._id, product.title)}>
