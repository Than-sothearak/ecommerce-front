...
const Review = ({ product }) => {
  ...
  return (
    <ProductReview>
         <OverallReview>
        <h1 className="text-3xl mt-10 text-center">Customer reviews & ratings</h1>
        <TotalReview>
        <h1 className="text-5xl font-bold mt-10 text-center text-gray-600">12</h1>
        <AllStar>
      ...
      <ReviewSubmit>
        <h1 className="text-3xl mt-10 text-start">Write your review</h1>
        <ReviewWrapper>
          <div>
