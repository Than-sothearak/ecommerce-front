...
export default function PcProductGrid({ products:originalProducts, wishedProduct = [],categories }) {
    ...
    {propertiesToFill[0].map(property =>  (
                  <Filter key={property.name}>
                    ...
                    <select
                      ...
                      value={ filtersValues[0].find((f) => f.name == property?.name).value}
                    >
