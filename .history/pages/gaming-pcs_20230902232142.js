...
const GamingPcs = ({ mainCategories, wishedProduct, productOfCategories,categories }) => {
  ...
  return (
    <>
      <Center>
        ...
        <PcProductGrid products={product} wishedProduct={wishedProduct} categories={categories} />
      </Center>
    </>
  );
};
...
export async function getServerSideProps(context) {
  ...
  for (let mainCat of mainCategories) {
    ...
    const childCategory = await Category.find({ parent: mainCategories._id });
